...
- running browser/page/locator scripts through `POST /api/pages/run`
...
- `POST /api/pages/run` returns `sessionId`, `pageIds`, `logs`, and `result`.
...
- Use the repo `README.md` for the full REST shape, action-array format, `/api/pages/run`, sample pages, and runnable examples.
